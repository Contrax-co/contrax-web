    ...
    <Card className="border-0 mt-5" background={colors.secondaryLight}>
      {showSetting && (
        <StyledSettingCard>
          ...
          <Row className="mt-1">
            <Col size="3">
              <StyledSmallBtn className="btn btn-primary m-1" type="button">
                0.5%
              </StyledSmallBtn>
            </Col>
            <Col size="3">
            ...
            <Col size="3">
              <StyledSmallInput height="39px" />{' '}
              <StyledInputDesc>%</StyledInputDesc>
            </Col>
          </Row>
      ...
      <H3 className="mt-1">
        Swap into more than 2000 tokens, using the best quotes from over 20
        sources.
      </H3>
      <DropdownInput
        label="Pay"
