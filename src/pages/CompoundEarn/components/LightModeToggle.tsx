  ...
  return (
    <div className="togglelight_container">
        ...
        <div className={`lighttoggle ${lightMode && "lighttoggle--light"}`} onClick={props.onClick}>
            <div className={`lighttoggle_switch ${lightMode && "lighttoggle_switch--light"}`}>

            </div>

        </div>
        {lightMode ? <MdOutlineDarkMode className={`label2 ${lightMode && "label2--light"}`} /> : <MdDarkMode className={`label2 ${lightMode && "label2--light"}`} />}
