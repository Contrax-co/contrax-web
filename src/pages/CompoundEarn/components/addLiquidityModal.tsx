  ...
  const depositAll = async () => {
    ...
    try {
      if (ethereum) {
        ...
        const gasPrice = await provider.getGasPrice();
        const depositAllTxn = await vaultContract.depositAll({
          gasLimit: gasPrice,
        });
                ...
                <form className="deposit_container" onSubmit={deposit}>
                  <div>
                    ...
                    <div className="deposit_amount">
                      ...
                      />
                      <p onClick={depositTotal} className="all_tokens">
                        MAX
                      </p>
                  ...
                  <div>
                    <p onClick={deposit} className="deposit_button">
                      Deposit
                    </p>
                    <p className="depositAll_button" onClick={depositAll}>
                      Deposit All
                    </p>
                  </div>
                </form>
