        ...
        <div className="description">
          ...
          {toggleType ? (
            <p className="description_description">
              This is a {platform} liquidity pool composed of{' '}
              <a
              ...
              then staked in the {platform} protocol for {rewards} rewards. All
              rewards are sold to purchase more LP tokens.{' '}
            </p>
          ) : (
            <p className="description_description">
              This is a {platform} liquidity pool composed of{' '}
              ...
              and the deposit token is then staked in the {platform} protocol
              for {rewards} rewards. All rewards are sold to purchase more LP
              tokens.{' '}
            </p>
          )}
        </div>
          ...
          {toggleType ? (
            <div className="deposit_tab">
              <div className="weth_deposit_amount">
                ...
                />
                <p onClick={depositTotalLP} className="all_weth_tokens">
                  MAX
                </p>
              </div>
              <div
                ...
                onClick={() =>
                  deposit(pool, lpDepositAmount, setLPDepositAmount, setLoading)
                }
              >
                <p>Deposit LP</p>
              </div>
            ...
            <div className="deposit_tab">
              <div className="weth_deposit_amount">
                ...
                />
                <p onClick={depositTotalEth} className="all_weth_tokens">
                  MAX
                </p>
              </div>
