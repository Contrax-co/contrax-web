  ...
  const getUserVaultBalance = async () => {
    ...
    try {
      if (ethereum) {
        ...
        console.log(
          `User's balance of the lp token in vault is: ${userVaultBalance}`
        );
      } else {
        ...
        <form className="amount" onSubmit={withdraw}>
          <div className="top">
            ...
            <div className="withdraw_amount">
              ...
              />
              <p onClick={withdrawTotal} className="allWithdraw_tokens">
                MAX
              </p>
          ...
          <div>
            <p onClick={withdraw} className="withdraw_button">
              Withdraw
            </p>
            <p onClick={withdrawAll} className="withdrawAll_button">
              Withdraw All
            </p>
          </div>
        </form>
