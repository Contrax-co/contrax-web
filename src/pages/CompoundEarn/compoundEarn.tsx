    ...
    <div>
        ...
        {pools.map((pool: any) => (
          <div className="single_pool" key={pool.id}>
            ...
            <div className="buttons">
              <PoolButton
                props={() =>
                  setWithdrawKey((withdrawKey) =>
                    withdrawKey === pool.id ? null : pool.id
                  )
                }
              ...
              <PoolButton
                props={() =>
                  setLiquidityKey((liquidityKey) =>
                    liquidityKey === pool.id ? null : pool.id
                  )
                }
      ...
      {liquidityModal ? (
        <AddLiquidity
          ...
          setLiquidityKey={setLiquidityKey}
          pool={pools}
          setLiquidityModal={setLiquidityModal}
        />
      ) : null}
      {withdrawModal ? (
        <DetailsModal
          withdrawKey={withdrawKey}
          setWithdrawKey={setWithdrawKey}
          pool={pools}
