...
export default function PoolDetail() {
  ...
  let poolChartDataList = [
    ['36,408,389.5732 USDC (84.46%)', '6,691,425.1753 USDT (15.54%)'],
    ['36,408,389.5732 USDC (84.46%)', 36408389.5732],
    ['6,691,425.1753 USDT (15.54%)', 6691425.1753],
  ];
  let swapsData = [
    {
      ...
      traderAddressUrl:
        'https://etherscan.io/address/0x30c5312d9cf0d873994f000e72f1cbf561d0209c',
      paidCurrency: '6,000 USDT',
      paidCurrencyMedia:
        'https://cmp.dodoex.io/d_AVO5xIyrJl_fT2ItXkdNeqyNcY_y1Rf4kix1tiMw8/rs:fit:20:20:0/g:no/aHR0cHM6Ly9jZG4tbWVkaWEuZG9kb2V4LmlvL1VTRFRfZThiNzFiNWYyOS9VU0RUX2U4YjcxYjVmMjkucG5n.webp',
      receiveCurrency: '6,004.24 USDC',
      receiveCurrencyMedia:
        'https://cmp.dodoex.io/9kfMyaEhJBOwCKTXWVoPU8yPTdyx9rX7sSu9CYqRuqA/rs:fit:20:20:0/g:no/aHR0cHM6Ly9jZG4tbWVkaWEuZG9kb2V4LmlvL3VzZGNfZWU1MmExZWQyYi91c2RjX2VlNTJhMWVkMmIucG5n.webp',
      price: '1 USDT = 1 USDC',
      feeRate: '0.008%',
      fee: '0.48 USDC',
    },
    {
      ...
      traderAddressUrl:
        'https://etherscan.io/address/0x2b6f908bf9082ad39adb27c04e88adfec8f58110',
  ...
  let liquidityProviderData = [
    ...
    },
    {
      ...
      liquidityProviderAddressUrl:
        'https://etherscan.io/address/0x10bf1dcb5ab7860bab1c3320163c6dddf8dcc0e4',
      ...
      <Container className=" mt-4 pt-1">
            ...
            <Card className="mt-3 border-0" background={colors.secondaryLight}>
              <span>
                <Link link={poolData.poolUrl} target="_blank" rel="noreferrer">
                  <B1>
                    {poolData.poolAddress.substring(0, 6)}...
                    {poolData.poolAddress.substring(38, 42)} &nbsp;
                  </B1>
              ...
              <Row className="row my-4">
                <Col>
                  <H3>My Pool Analysis</H3>
                </Col>
                <Row className="row">
                  <Col className="d-flex flex-column align-items-center">
                    <Row className="mb-3 mt-5">
                      <Icon name="fa-chart-bar fa-2x faround"></Icon>
                    </Row>
                    <Row>
                      <B1 bold>24</B1>
                    </Row>
                    <Row>
                      <B1 color={colors.accentDark}>Traders (24H)</B1>
                    </Row>
                  </Col>
                  <Col className="d-flex flex-column align-items-center">
                    <Row className="mb-3 mt-5">
                      <Icon name="fa-briefcase fa-2x faround"></Icon>
                    </Row>
                    <Row>
                      <B1 bold>$43.1M</B1>
                    </Row>
                    <Row>
                      <B1 color={colors.accentDark}>Total Liquidity</B1>
                    </Row>
                  </Col>
                </Row>
                <Row>
                  <Col className="d-flex flex-column align-items-center">
                    <Row className="mb-3 mt-5">
                      <Icon name="fa-chart-line fa-2x faround"></Icon>
                    </Row>
                    <Row>
                      <B1 bold>$22.43M</B1>
                    </Row>
                    <Row>
                      <B1 color={colors.accentDark}>Volume</B1>
                    </Row>
                  </Col>
                  <Col className="d-flex flex-column align-items-center">
                    <Row className="mb-3 mt-5">
                      <Icon name="fa-donate fa-2x faround"></Icon>
                    </Row>
                    <Row>
                      <B1 bold>$1.79K</B1>
                    </Row>
                    <Row>
                      <B1 color={colors.accentDark}>Fees (24H)</B1>
                    </Row>
                  </Col>
                </Row>
                <Row className="mt-4">
        ...
        <ul className="nav nav-tabs" id="myTab" role="tablist">
          ...
          <li className="nav-item" role="presentation">
            <button
              className="nav-link"
              id="liquidity-providers-tab"
              data-bs-toggle="tab"
              data-bs-target="#liquidity-providers"
              type="button"
              role="tab"
              aria-controls="liquidity-providers"
              aria-selected="false"
            >
        ...
        <div className="tab-content" id="myTabContent">
                ...
                <Row className="my-3">
                  ...
                  <Col size="8">
                    ...
                    <B1>
                      10,575,363,434 USDT
                      <Image
                        src="https://cmp.dodoex.io/d_AVO5xIyrJl_fT2ItXkdNeqyNcY_y1Rf4kix1tiMw8/rs:fit:20:20:0/g:no/aHR0cHM6Ly9jZG4tbWVkaWEuZG9kb2V4LmlvL1VTRFRfZThiNzFiNWYyOS9VU0RUX2U4YjcxYjVmMjkucG5n.webp"
                        alt=""
                        className="ms-1"
                      />{' '}
                      / 10,577,149,605 USDC
                      <Image
                        src="https://cmp.dodoex.io/9kfMyaEhJBOwCKTXWVoPU8yPTdyx9rX7sSu9CYqRuqA/rs:fit:20:20:0/g:no/aHR0cHM6Ly9jZG4tbWVkaWEuZG9kb2V4LmlvL3VzZGNfZWU1MmExZWQyYi91c2RjX2VlNTJhMWVkMmIucG5n.webp"
                        alt=""
                        className="ms-1"
                      />
                    </B1>
                ...
                <Row className="my-3">
                  ...
                  <Col size="8">
                    ...
                    >
                      ...
                      {poolData.poolAddress.substring(38, 42)}{' '}
                      <i
                        className="fa fa-external-link text-dark"
                        aria-hidden="true"
                      ></i>
                    </Link>
                  </Col>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <span>
                        {' '}
                        <Link
                          link={item.traderAddressUrl}
                          target="_blank"
                          rel="noreferrer"
                        >
                          {' '}
                          {item.traderAddress.substring(0, 6)}...
                          {item.traderAddress.substring(38, 42)}{' '}
                          <i
                            className="fa fa-external-link text-dark"
                            aria-hidden="true"
                          ></i>{' '}
          ...
          <div
            ...
            role="tabpanel"
            aria-labelledby="liquidity-providers"
          >
            <table className="table table-hover my-4">
              <thead>
                <tr className="table-light">
                  ...
                  <tr>
                    <td>
                      ...
                      <span>
                        {' '}
                        <Link
                          link={item.liquidityProviderAddressUrl}
                          target="_blank"
                          rel="noreferrer"
                        >
                          {' '}
                          {item.liquidityProviderAddress.substring(0, 6)}...
                          {item.liquidityProviderAddress.substring(38, 42)}{' '}
                          <i
                            className="fa fa-external-link text-dark"
                            aria-hidden="true"
                          ></i>{' '}
                    ...
                    <td>
                      <span>
                        {' '}
                        <Image
                          src={item.liquiditySuppliedPaidCurrencyMedia}
                          alt=""
                        />{' '}
                        {item.liquiditySuppliedPaidCurrency}{' '}
                      </span>
                      <br />
                      <span>
                        {' '}
                        <Image
                          src={item.liquiditySuppliedReceiveCurrencyMedia}
                          alt=""
                        />{' '}
                        {item.liquiditySuppliedReceiveCurrency}{' '}
                      </span>
                    </td>
                    <td>{item.value}</td>
                    <td>{item.share}</td>
