            ...
            <tbody>
                {
                    tableData.map((item, index) => (
                        ...
                        <td> 
                            <span> <img src={duckIcon} alt="duck icon"></img> {item.liquidityValue1} {item.liquidityName1}</span> 
                            <br /> 
                            <span> <img src={duckIcon} alt="duck icon"></img> {item.liquidityValue2} {item.liquidityName2}</span>
                        </td>
